          ...
          <div className="atbdp-accordion">
            <div className="accordion-single selected">
              ...
              <p className="ac-body" style={{ display: "block" }}>
                ...
                tium doloremque laudantium, totam rem aperiam the eaque ipsa
                quae abillo was inventore veritatis keret quasi aperiam
                architecto beatae vitae dicta sunt explicabo. Nemo ucxqui
                officia voluptatem accusantium.
              </p>
            </div>
            <div className="accordion-single">
              <h3 className="faq-title">
