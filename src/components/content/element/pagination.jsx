...
export class Pagination extends Component {
  ...
  render() {
    ...
    const project = Object.values(page).slice(
      count * perPage,
      count * perPage + perPage
    );
        ...
        <div className="pagination-area">
          ...
          >
            <ul className="pagination justify-content-center">
              <li className="page-item prev" onClick={prev}>
              ...
              {Object.values(this.props.page).map((value, key) => {
                return (
                  key <= item_length - 1 && (
                    <li
                      key={key}
                      className={`page-item click ${key === 0 && "active"}`}
                    >
                      <NavLink className="page-link" to="#">
                        {key + 1}
                      </NavLink>
              ...
              <li className="page-item next" onClick={next}>
                <NavLink className="page-link" to="#">
                  Next
                </NavLink>
              </li>
