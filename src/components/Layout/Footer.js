                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                ...
                                <ul className="list-unstyled footer-list mt-4">
                                    ...
                                    <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right mr-1"></i> Team</Link></li>
                                    <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right mr-1"></i> Pricing</Link></li>
                                    <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right mr-1"></i> Features</Link></li>
                                    <li><Link to="#" className="text-foot"><i className="mdi mdi-chevron-right mr-1"></i> FAQ</Link></li>
                            ...
                            <div className="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <h4 className="text-light footer-head">Takipte Kalın!</h4>
                                <p className="mt-4">Yeni eğitimlerde ve yazılardan haberdar olun</p>
                                <form>
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="foot-subscribe form-group position-relative">
                                                ...
                                                <input type="email" name="email" id="emailsubscribe" className="form-control pl-5 rounded" placeholder="E-posta : " required />
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                            <input type="submit" id="submitsubscribe" name="send" className="btn btn-primary w-100" value="Kayıt ol" />
                                        </div>
                                    </div>
                                </form>
                            </div>
