    ...
    <Fragment>
      <div className="post-details">
        ...
        <div className="post-content">
          ...
          <div className="post-body">
            <p style={{ fontSize: "21px" }}>{content}</p>
            <p style={{ fontSize: "21px" }}>
              Business and Finance Sequitur mutatin onem consuetudium. Investiga
              tiones demonstr aver unt lectores legere me lius quod ii qua
              legunt saepius. Claritas est etiam pro cessus.
            </p>
            <div className="m-top-45 m-bottom-50">
              <blockquote className="blockquote blockquote1">
                <p style={{ fontSize: "21px" }}>
                  My focus areas are on global standardization and harmonization
                  of business processes lorem dolor is reorganization of
                  marketing and customer.
                </p>
                <div className="quote-author">
                  <p>
                    <span>Jeff Collins,</span> Founder of Tejarat Inc.
                  </p>
                </div>
              </blockquote>
              {/*<!-- end: blockquote -->*/}
            ...
            <p style={{ fontSize: "21px" }}>
              Investig ationes demons trave runt lectores legere liusry quod was
              legunt saepius claritas Investig tones. Pharetra dui, nec
              tincidunt ante mauris eu diam. Phasellus verra nisl vitae cursus
              aei uismod supen dise saepius claritas investig. Investiga tiones
            ...
            <div className="m-bottom-40">
              <ul className="list-unstyled bullet-list">
                ...
                <li>
                  Explore and design dynamic compelling consumer experiences.
                </li>
                <li>
            ...
            <p style={{ fontSize: "21px" }}>
              Investig ationes demons trave runt lectores legere liusry quod was
              legunt saepius claritas Investig tones. Pharetra dui, nec
              tincidunt ante mauris eu diam hasellus verra cursus.
            </p>
            <div className="row m-bottom-45">
              ...
              <div className="col-lg-7">
                <p style={{ fontSize: "21px" }}>
                  ...
                  was legunt saepius claritas Investig tones haretra dui, nec
                  tincidunt ante mauris eu diam. Phasellus verra nisl vitae
                  cursus aei uismod supen dise saepius claritas legere melius
                  tones haretra.
                </p>
              </div>
            </div>
            ...
            <p style={{ fontSize: "21px" }}>
              Investig ationes demons trave runt lectores legere liusry quod was
              legunt saepius claritas Investig tones. Phasellus verrade monstr
              averun dlectores legere melius verrade monstr averun dlectores.
            </p>
            ...
            <p style={{ fontSize: "21px" }} className="m-top-30">
              Investig ationes demons trave runt lectores legere liusry quod was
              legunt saepius claritas Investig tones. Pharetra dui, nec
              tincidunt ante mauris eu diam. Phasellus verra nisl vitae cursus
              aei uismod supen dise saepius claritas investig. Investiga tiones.
      ...
      <div className="post-bottom d-flex justify-content-between">
        ...
        <div className="social-share d-flex align-items-center">
          ...
          <ul className="social-share list-unstyled">
            <li>
              <NavLink to="/at_demo" onClick={noAction} className="facebook">
            ...
            <li>
              <NavLink to="/at_demo" onClick={noAction} className="linkedin">
      ...
      <div className="post-author cardify border">
        ...
        <div className="author-info">
          <h5>
            <span>Bilgi Akademi</span>
          </h5>
          <p>
            Business and Finance Sequitur mutatin onem consuetudium. Investiga
            tiones demonstr aver unt lectores legere me lius quod kqua legunt
            saepius. Claritas est etiam pro cessus averus.
          </p>
      ...
      <div className="post-pagination">
        <div className="prev-post">
          ...
          <NavLink to="/at_demo" onClick={noAction} className="title">
            How to Run a Successful Business Meeting
          </NavLink>
          <p>
            <span>Aug 12, 2019</span> - In{" "}
            <NavLink to="/at_demo" onClick={noAction}>
              Industry
            </NavLink>
          </p>
        ...
        <div className="next-post">
          <span>Next Post:</span>
          <NavLink to="/at_demo" onClick={noAction} className="title">
            Exciting New Technologies Business Communication
          </NavLink>
          <p>
            <span>Aug 12, 2019</span> - In{" "}
            <NavLink to="/at_demo" onClick={noAction}>
              ...
              return (
                <div className="col-lg-4 col-sm-6" key={value.id}>
                  <div className="single-post">
                    ...
                    <h6>
                      <NavLink to={`/news-details${value.id}`}>
                        Pi (π) Sayısının Gizemi
                      </NavLink>
                    </h6>
                    <p>
      ...
      <div className="comments-area m-top-60">
                ...
                <div className="media-body">
                  <div className="media_top">
                    <div className="heading_left">
                      <NavLink to="/at_demo" onClick={noAction}>
                        <h6 className="media-heading">Enes Şahin</h6>
                      </NavLink>
                      <span>Nisan 29, 2019</span>
                    </div>
                    <NavLink to="/at_demo" onClick={noAction} className="reply">
                      <i className="la la-reply"></i> Yanıtla
                    </NavLink>
                  </div>
                  <p>
                    Çok güzel bir makale olmuş tebrikler...Yeni yazılarınızı
                  ...
                  <div className="media">
                    ...
                    <div className="media-body">
                      <div className="media_top">
                        <div className="heading_left">
                          <NavLink to="/at_demo" onClick={noAction}>
                            <h6 className="media-heading">Metehan Bacı</h6>
                          </NavLink>
                          <span>Nisan 29, 2019</span>
                        </div>
                        <NavLink
                      ...
                      <p>
                        Bencede Enes Şahin'e katılıyorum.Tabi kendisinden
                        alınacak feyz ile daha etkili yazılar da çıkabilir.
                      </p>
                    </div>
                  </div>
                </li>
              ...
              <div className="media">
                ...
                <div className="media-body">
                  <div className="media_top">
                    <div className="heading_left">
                      <NavLink to="/at_demo" onClick={noAction}>
                        <h6 className="media-heading">Ali Şahin</h6>
                      </NavLink>
                      <span>Mayıs 01, 2019</span>
                    </div>
                    <NavLink to="/at_demo" onClick={noAction} className="reply">
                      <i className="la la-reply"></i> Yanıtla
                    </NavLink>
                  ...
                  <p>
                    Kiri'yi hesaba kattığımızda illaki düşük kalıyor bu makale.
                    Fakat öyle bir teknolojiye karşı gerçekten başarılı olmuş.
                    Tebrikler...
                  </p>
                </div>
              </div>
        ...
        <div className="text-center m-top-50">
          <NavLink
            to="/at_demo"
            onClick={noAction}
            className="btn btn-outline-secondary btn-icon icon-left"
          >
            <i className="la la-refresh"></i> Load More
          </NavLink>
        </div>
      </div>
      {/*<!-- ends: .comment-area -->*/}
