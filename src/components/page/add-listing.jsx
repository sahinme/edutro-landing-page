                          ...
                          <div className="directorist atbdp_social_field_wrapper">
                            ...
                            >
                              ...
                              <div className="col-sm-2 d-flex align-items-center">
                                ...
                                <span className="adl-move-icon btn-secondary">
              ...
              <div className="col-lg-10 offset-lg-1">
                <div className="atbd_content_module">
                  <div className="atbd_content_module__tittle_area">
                    <div className="atbd_area_title">
                      <h4>
                        <span className="la la-calendar-check-o"></span> Listing
                        FAQs
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="atbdb_content_module_contents">
                    ...
                    <div className="cor-wrap form-group">
                      <div className="atbd_mark_as_closed custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                        ...
                        />
                        <label
                          htmlFor="manual_coordinate"
                          className="not_empty custom-control-label"
                        >
                          Or Enter Coordinates (latitude and longitude)
                          Manually.{" "}
                        </label>
                      </div>
                    </div>
                    <div className="cor-form">
                      <div
                        id="hide_if_no_manual_cor"
                        className="clearfix row m-bottom-30"
                      >
                        <div className="col-sm-6">
                          <div className="form-group">
              ...
              <div className="col-lg-10 offset-lg-1">
                <div className="atbd_content_module">
                  <div className="atbd_content_module__tittle_area">
                    <div className="atbd_area_title">
                      <h4>
                        <span className="la la-calendar-check-o"></span> Images
                        & Video
                      </h4>
                    </div>
                  </div>
                  <div className="atbdb_content_module_contents">
                    ...
                    <div className="form-group m-top-30">
                      <label
                        htmlFor="videourl"
                        className="not_empty form-label"
                      >
                        Video Url
                      </label>
                      <input
