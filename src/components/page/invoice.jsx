              ...
              <div className="col-lg-10 offset-lg-1">
                <div className="payment_receipt--wrapper">
                  <div className="payment_receipt--contents">
                    <h2 className="atbd_thank_you">
                      Thank you for your order!
                    </h2>
                    <div className="atbd_payment_instructions">
                      <p>
                        Please make your payment directly to our bank account
                        and use your ORDER ID (#499) as a Reference. Our bank
                        account information is given below.
                      </p>
                      <h4>Account details:</h4>
                      <ul className="list-unstyled">
                        <li>
                          Account Name: <span>Direo Inc.</span>
                        </li>
                        <li>
                          Account Number: <span>000-123-4567890</span>
                        </li>
                        <li>
                          Bank Name: <span>State Bank, Neverland</span>
                        </li>
                      </ul>
                      <p>
                        Please remember that your order may be canceled if you
                        do not make your payment within next 72 hours.
                      </p>
                    </div>
                    {/*<!-- ends: .atbd_payment_instructions -->*/}
                    <div className="row atbd_payment_summary_wrapper">
                      <div className="col-md-12">
                        <p className="atbd_payment_summary">
                    ...
                    {/*<!-- ends: .atbd_payment_summary_wrapper -->*/}
                          ...
                          <tr>
                            <td colSpan="2">
                              ...
                              <p>
                                ...
                                adipisicing elit. Explicabo, labore.
                              </p>
                            </td>
                            <td>$45.00</td>
                          </tr>
