          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="atbd_content_module atbd_custom_fields_contents">
                <div className="atbd_content_module__tittle_area">
                  <div className="atbd_area_title">
                    <h4>
                      <span className="la la-youtube-play"></span>Video
                    </h4>
                  </div>
                </div>
                <Video />
              ...
              <div className="atbd_content_module atbd_contact_information_module">
                <div className="atbd_content_module__tittle_area">
                  <div className="atbd_area_title">
                    <h4>
                      <span className="la la-headphones"></span>Contact
                      Information
                    </h4>
                  </div>
                </div>
              ...
              <div className="atbd_content_module atbd_faqs_module">
                <div className="atbd_content_module__tittle_area">
                  <div className="atbd_area_title">
                    <h4>
                      <span className="la la-question-circle"></span>Lisiitng
                      FAQ's
                    </h4>
                  </div>
                </div>
            ...
            <div className="col-lg-4">
              ...
              <div className="widget atbd_widget widget-card">
                <div className="atbd_widget_title">
                  <h4>
                    <span className="la la-map-marker"></span> Sidebar Map
                  </h4>
                </div>
                {/*<!-- ends: .atbd_widget_title -->*/}
              ...
              <div className="widget atbd_widget widget-card">
                <div className="atbd_widget_title">
                  <h4>
                    <span className="la la-envelope"></span> Sidebar Form
                  </h4>
                </div>
                {/*<!-- ends: .atbd_widget_title -->*/}
              ...
              <div className="widget atbd_widget widget-card">
                <div className="atbd_widget_title">
                  <h4>
                    <span className="la la-list-alt"></span> Similar Listings
                  </h4>
              ...
              <div className="widget atbd_widget widget-card">
                <div className="atbd_widget_title">
                  <h4>
                    <span className="la la-list-alt"></span> Popular Listings
                  </h4>
                  <NavLink to="/all-listings-grid">View All</NavLink>
                </div>
                {/*<!-- ends: .atbd_widget_title -->*/}
