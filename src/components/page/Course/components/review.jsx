            ...
            <div id="client_review_list">
              <div className="atbd_single_review atbdp_static">
                ...
                <div className="review_content">
                  <p>
                    Lacinia eget consectetur sed, convallis at tellus. Vivamus
                    magna justo, lacinia eget consectetur sed, convallis at
                    tellus. Vestibulum ac diam sit amet quam vehicula elementum
                ...
                <div className="review_reply_form">
                  <div className="atbd_review_avatar">
                    <img
                      alt=""
                      src="./assets/img/review-author-thumb2.jpg"
                      className="avatar avatar-32 photo"
                    />
                  </div>
                  <form action="/">
                ...
                <div className="atbd_review_top">
                  <div className="atbd_avatar_wrapper">
                    <div className="atbd_review_avatar">
                      <img
                        alt=""
                        src="./assets/img/review-author-thumb3.jpg"
                        className="avatar avatar-32 photo"
                      />
                    </div>
                    <div className="atbd_name_time">
              ...
              <div className="form-group">
                ...
                <div className="atbd_upload_btn_wrap">
                  <label htmlFor="atbd_review_attachment">
                    <input
                      type="file"
                      id="atbd_review_attachment"
                      hidden
                      multiple
                    />
                    <span className="btn btn-md atbd_upload_btn">
                      <span className="la la-cloud-upload"></span>Upload Photo
                    </span>
                  </label>
