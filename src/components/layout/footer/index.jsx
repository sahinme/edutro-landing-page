                ...
                <div className="col-lg-2 col-sm-6">
                  <div className="widget widget_pages">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="page-item">
                        <NavLink to="/all-listings-grid">Our Listings</NavLink>
                      </li>
                      <li className="page-item">
                        <NavLink to="/pricing-plans">Ödeme Planı</NavLink>
                      </li>
                      <li className="page-item">
                        <NavLink onClick={noAction} to="/support">
                          Yardım
                        </NavLink>
                      </li>
                      <li className="page-item">
                        <NavLink onClick={noAction} to="/policy">
                          Privacy Policy
                        </NavLink>
                      </li>
                    </ul>
                    ...
                    <div className="textwidget">
                      ...
                      <ul className="list-unstyled store-btns">
                        <li>
                          ...
                          >
                            <span className="fab fa-apple" /> App Store
                          </NavLink>
                        </li>
                        <li>
                          <NavLink
                            onClick={noAction}
                            to="/google-play"
                            className="btn btn-dark btn-md btn-icon btn-icon"
                          >
                            <span className="fab fa-android" /> Google Play
                          </NavLink>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="col-lg-12">
                  <div className="footer-bottom--content">
                    ...
                    <ul className="list-unstyled lng-list">
                      <li>
                        <NavLink onClick={noAction} to="/english">
                          English
                        </NavLink>
                      </li>
                    </ul>
